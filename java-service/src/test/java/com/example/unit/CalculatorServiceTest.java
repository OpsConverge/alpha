...
public class CalculatorServiceTest {
    ...
    void shouldAddVariousNumbers(double a, double b, double expected) {
        ...
        assertEquals(expected, result, String.format("%.1f + %.1f should equal %.1f", a, b, expected));
    }
    ...
    void shouldSubtractTwoPositiveNumbers() {
        ...
        assertEquals(2.0, result, "5.0 - 3.0 should equal 2.0");
    }
    ...
    void shouldMultiplyTwoPositiveNumbers() {
        ...
        assertEquals(15.0, result, "5.0 * 3.0 should equal 15.0");
    }
    ...
    void shouldDivideTwoPositiveNumbers() {
        ...
        assertEquals(3.0, result, "6.0 / 2.0 should equal 3.0");
    }
